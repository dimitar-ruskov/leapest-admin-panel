...
} from "../containers/internal-repository-details-courses/state/internal-repository-courses.state";
import {
...
} from "../containers/internal-repository-details-variants/state/internal-repository-variants.state";

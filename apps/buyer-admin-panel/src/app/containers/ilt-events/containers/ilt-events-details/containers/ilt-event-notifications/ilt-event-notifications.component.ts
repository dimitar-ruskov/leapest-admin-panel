...
@Component({
  ...
  templateUrl: './ilt-event-notifications.component.html',
  styleUrls: ['./ilt-event-notifications.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
@UntilDestroy()
export class IltEventNotificationsComponent implements OnInit, OnDestroy {
  @Select((state: IGlobalStateModel) => state.iltEvents.iltEventDetails['iltEventDetailsNotifications'].notifications)
  notifications$: Observable<DeferredResource<NotificationModel[]>>;

  @Select((state: IGlobalStateModel) => state.iltEvents.iltEventDetails['iltEventDetailsNotifications'].sort)
  sort$: Observable<Sort>;

  @Select((state: IGlobalStateModel) => state.iltEvents.iltEventDetails['iltEventDetailsNotifications'].pagination)
  pagination$: Observable<IPageable>;

  @Select((state: IGlobalStateModel) => state.iltEvents.iltEventDetails['iltEventDetailsNotifications'].searchForm)
  ...
  @Select((state: IGlobalStateModel) => state.iltEvents.iltEventDetails['iltEventDetailsNotifications'].searchMetadata)
  ...
  ngOnInit(): void {
    this.eventSku = this.route.snapshot.paramMap.get('sku');
  ...
  openPreviewTemplate(payload: NotificationModel, event: MouseEvent): void {
    ...
    this.store.dispatch(new PreviewNotificationTemplate(data, payload.courseEventId));
  ...
  private fetchNotifications(): void {
    this.store.dispatch(new FetchEventDetailsILTNotifications());
